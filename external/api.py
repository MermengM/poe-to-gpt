...
# 获取toml配置文件中的bot字典
bot_config_dict = config['bot']

# 自动生成bot_names字典
bot_names = {value: value for value in bot_config_dict.values()}
logging.info(bot_names)
# 检查bot_names中是否有"Assistant"，如果没有则添加
if "Assistant" not in bot_names:
    bot_names["Assistant"] = "Assistant"
